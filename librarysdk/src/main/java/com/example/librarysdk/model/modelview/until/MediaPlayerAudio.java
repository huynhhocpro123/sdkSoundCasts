package com.example.librarysdk.model.modelview.until;
...
import com.example.librarysdk.model.modelview.interfaceplayer.MediaListener;

import java.io.IOException;

import static android.util.Log.d;
import static com.example.librarysdk.model.modelview.until.Contanst.COMPLETE;
import static com.example.librarysdk.model.modelview.until.Contanst.FIRSTQUARTILE;
import static com.example.librarysdk.model.modelview.until.Contanst.MIDPOINT;
import static com.example.librarysdk.model.modelview.until.Contanst.MILISECONDS;
import static com.example.librarysdk.model.modelview.until.Contanst.START;
import static com.example.librarysdk.model.modelview.until.Contanst.THIRDQUARTILE;
import static com.example.librarysdk.model.modelview.until.Contanst.TOKEN;
import static com.example.librarysdk.model.modelview.until.Contanst.URLRQUEST;
    ...
    private Runnable UpdateSongTime = new Runnable() {
        public void run() {
            ...
            if (startTime / MILISECONDS > 0) {
                d(TAB, "mediaPlayerAdvertisement.getCurrentPosition() / Contanst.MILISECONDS:???" + startTime / MILISECONDS);
                if (startTime / MILISECONDS == (finalTime / MILISECONDS) / 4) {
                    d(TAB, "mediaPlayerAdvertisement.getCurrentPosition() / Contanst.MILISECONDS == (totalTime / Contanst.MILISECONDS) / 4:>>>>" + (finalTime / MILISECONDS) / 4);
